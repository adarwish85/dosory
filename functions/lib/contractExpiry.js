...
exports.trialExpiryCheck = exports.contractAutoExpiry = void 0;
 ...
 */
exports.contractAutoExpiry = functions.pubsub
    .schedule("0 1 * * *")
    .timeZone("UTC")
    .onRun(async () => {
 ...
 */
exports.trialExpiryCheck = functions.pubsub
    .schedule("0 2 * * *")
    .timeZone("UTC")
    .onRun(async () => {
...
//# sourceMappingURL=contractExpiry.js.map