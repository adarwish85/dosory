        ...
        if (toEmail) {
            promises.push(getResend().emails.send({
                ...
                html: `
                        ...
                        <p><a href="${((_c = functions.config().app) === null || _c === void 0 ? void 0 : _c.url) || "https://yourapp.com"}/dashboard">View Dashboard</a></p>
                    `,
