...
exports.getProposalCreatedEmail = getProposalCreatedEmail;
exports.getProposalStatusEmail = getProposalStatusEmail;
...
function getProposalCreatedEmail(data) {
    return {
...
function getProposalStatusEmail(data) {
