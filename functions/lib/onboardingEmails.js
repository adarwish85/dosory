...
const EMAIL_TEMPLATES = {
    ...
    day3: {
        ...
        getHtml: (userName, incompleteTasks) => `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
exports.sendOnboardingEmails = functions.pubsub
    ...
    for (const doc of usersSnapshot.docs) {
        try {
            ...
            if (state.completed || state.skippedAt)
                continue;
            ...
            const userName = userRecord.displayName || (userEmail === null || userEmail === void 0 ? void 0 : userEmail.split("@")[0]) || "there";
            if (!userEmail)
                continue;
            ...
            if (!state.steps.companyProfile)
                incompleteTasks.push("Complete your company profile");
            if (!state.steps.firstRecord)
                incompleteTasks.push("Add your first customer or lead");
            if (!state.steps.inviteTeam)
                incompleteTasks.push("Invite team members");
            // Get email template
...
//# sourceMappingURL=onboardingEmails.js.map