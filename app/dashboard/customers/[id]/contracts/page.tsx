...
export default function ContractsPage() {
    ...
    const { contracts, loading: contractsLoading } = useContracts({ customerId: customerId || undefined });
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50 hover:bg-gray-50">
                                ...
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">Contract Value</TableHead>
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">Start Date</TableHead>
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">End Date</TableHead>
