...
export default function ProjectsPage() {
    ...
    const { projects, loading: projectsLoading } = useProjects({ customerId: customerId || undefined });
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50 hover:bg-gray-50">
                                ...
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">Progress</TableHead>
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">Start Date</TableHead>
                                <TableHead className="font-semibold text-gray-900 bg-gray-100/50">Deadline</TableHead>
