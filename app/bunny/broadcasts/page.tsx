...
export default function BroadcastsPage() {
    ...
    const handleCreateBanner = async () => {
        ...
        try {
            ...
            await logAdminAction(
                ...
                "create_banner",
                { name: "System Banner" },
                { message: bannerMessage, type: bannerType }
            );
    ...
    const handleSendEmail = async () => {
        ...
        if (
            !confirm(
                `Are you sure you want to send this email to ${targetAudience === "all" ? "ALL" : targetAudience} tenants? This action cannot be undone.`
            )
        )
            return;
        ...
        try {
            ...
            await logAdminAction(
                ...
                { name: emailSubject },
                { target: targetAudience, recpients: data.count }
            );
                            ...
                            <div className="space-y-3 mt-6">
                                ...
                                {loadingBanners ? (
                                    ...
                                    banners.map((banner) => (
                                        <div
                                            key={banner.id}
                                            className="flex items-center justify-between p-4 rounded-lg border border-gray-200 bg-white shadow-sm"
                                        >
